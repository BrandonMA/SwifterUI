...
public extension UIView {
    ...
    @discardableResult
    public func clipEdges(to view: UIView? = nil, margin: UIEdgeInsets = .zero, exclude: [ConstraintEdge] = [], relation: ConstraintRelation = .equal, useSafeArea: Bool = true) -> [Constraint?] {
