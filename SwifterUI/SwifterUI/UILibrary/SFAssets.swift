...
//  SwifterUI
//
//  Created by Brandon Maldonado Alonso on 23/04/18.
...
public class SFAssets : NSObject {
    ...
    @objc dynamic public class func drawShareIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 21, height: 28), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 21, height: 28), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 21, y: resizedFrame.height / 28)
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 15.17, y: 11.67))
        bezierPath.addCurve(to: CGPoint(x: 14, y: 10.5), controlPoint1: CGPoint(x: 14.52, y: 11.67), controlPoint2: CGPoint(x: 14, y: 11.14))
        bezierPath.addCurve(to: CGPoint(x: 15.17, y: 9.33), controlPoint1: CGPoint(x: 14, y: 9.86), controlPoint2: CGPoint(x: 14.52, y: 9.33))
        bezierPath.addLine(to: CGPoint(x: 16.84, y: 9.33))
        bezierPath.addCurve(to: CGPoint(x: 19.19, y: 9.78), controlPoint1: CGPoint(x: 17.97, y: 9.33), controlPoint2: CGPoint(x: 18.57, y: 9.45))
        bezierPath.addCurve(to: CGPoint(x: 20.55, y: 11.14), controlPoint1: CGPoint(x: 19.77, y: 10.09), controlPoint2: CGPoint(x: 20.24, y: 10.56))
        bezierPath.addCurve(to: CGPoint(x: 21, y: 13.49), controlPoint1: CGPoint(x: 20.88, y: 11.77), controlPoint2: CGPoint(x: 21, y: 12.37))
        bezierPath.addLine(to: CGPoint(x: 21, y: 23.84))
        bezierPath.addCurve(to: CGPoint(x: 20.55, y: 26.19), controlPoint1: CGPoint(x: 21, y: 24.97), controlPoint2: CGPoint(x: 20.88, y: 25.57))
        bezierPath.addCurve(to: CGPoint(x: 19.19, y: 27.55), controlPoint1: CGPoint(x: 20.24, y: 26.77), controlPoint2: CGPoint(x: 19.77, y: 27.24))
        bezierPath.addCurve(to: CGPoint(x: 16.84, y: 28), controlPoint1: CGPoint(x: 18.57, y: 27.88), controlPoint2: CGPoint(x: 17.97, y: 28))
        bezierPath.addLine(to: CGPoint(x: 4.16, y: 28))
        bezierPath.addCurve(to: CGPoint(x: 1.81, y: 27.55), controlPoint1: CGPoint(x: 3.03, y: 28), controlPoint2: CGPoint(x: 2.43, y: 27.88))
        bezierPath.addCurve(to: CGPoint(x: 0.45, y: 26.19), controlPoint1: CGPoint(x: 1.23, y: 27.24), controlPoint2: CGPoint(x: 0.76, y: 26.77))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 23.84), controlPoint1: CGPoint(x: 0.12, y: 25.57), controlPoint2: CGPoint(x: 0, y: 24.97))
        bezierPath.addLine(to: CGPoint(x: 0, y: 13.49))
        bezierPath.addCurve(to: CGPoint(x: 0.45, y: 11.14), controlPoint1: CGPoint(x: 0, y: 12.37), controlPoint2: CGPoint(x: 0.12, y: 11.77))
        bezierPath.addCurve(to: CGPoint(x: 1.81, y: 9.78), controlPoint1: CGPoint(x: 0.76, y: 10.56), controlPoint2: CGPoint(x: 1.23, y: 10.09))
        bezierPath.addCurve(to: CGPoint(x: 4.16, y: 9.33), controlPoint1: CGPoint(x: 2.43, y: 9.45), controlPoint2: CGPoint(x: 3.03, y: 9.33))
        bezierPath.addLine(to: CGPoint(x: 5.83, y: 9.33))
        bezierPath.addCurve(to: CGPoint(x: 7, y: 10.5), controlPoint1: CGPoint(x: 6.48, y: 9.33), controlPoint2: CGPoint(x: 7, y: 9.86))
        bezierPath.addCurve(to: CGPoint(x: 5.83, y: 11.67), controlPoint1: CGPoint(x: 7, y: 11.14), controlPoint2: CGPoint(x: 6.48, y: 11.67))
        bezierPath.addLine(to: CGPoint(x: 4.16, y: 11.67))
        bezierPath.addCurve(to: CGPoint(x: 2.91, y: 11.84), controlPoint1: CGPoint(x: 3.39, y: 11.67), controlPoint2: CGPoint(x: 3.15, y: 11.71))
        bezierPath.addCurve(to: CGPoint(x: 2.51, y: 12.24), controlPoint1: CGPoint(x: 2.73, y: 11.94), controlPoint2: CGPoint(x: 2.6, y: 12.07))
        bezierPath.addCurve(to: CGPoint(x: 2.33, y: 13.49), controlPoint1: CGPoint(x: 2.38, y: 12.48), controlPoint2: CGPoint(x: 2.33, y: 12.72))
        bezierPath.addLine(to: CGPoint(x: 2.33, y: 23.84))
        bezierPath.addCurve(to: CGPoint(x: 2.51, y: 25.09), controlPoint1: CGPoint(x: 2.33, y: 24.61), controlPoint2: CGPoint(x: 2.38, y: 24.85))
        bezierPath.addCurve(to: CGPoint(x: 2.91, y: 25.49), controlPoint1: CGPoint(x: 2.6, y: 25.27), controlPoint2: CGPoint(x: 2.73, y: 25.4))
        bezierPath.addCurve(to: CGPoint(x: 4.16, y: 25.67), controlPoint1: CGPoint(x: 3.15, y: 25.62), controlPoint2: CGPoint(x: 3.39, y: 25.67))
        bezierPath.addLine(to: CGPoint(x: 16.84, y: 25.67))
        bezierPath.addCurve(to: CGPoint(x: 18.09, y: 25.49), controlPoint1: CGPoint(x: 17.61, y: 25.67), controlPoint2: CGPoint(x: 17.85, y: 25.62))
        bezierPath.addCurve(to: CGPoint(x: 18.49, y: 25.09), controlPoint1: CGPoint(x: 18.27, y: 25.4), controlPoint2: CGPoint(x: 18.4, y: 25.27))
        bezierPath.addCurve(to: CGPoint(x: 18.67, y: 23.84), controlPoint1: CGPoint(x: 18.62, y: 24.85), controlPoint2: CGPoint(x: 18.67, y: 24.61))
        bezierPath.addLine(to: CGPoint(x: 18.67, y: 13.49))
        bezierPath.addCurve(to: CGPoint(x: 18.49, y: 12.24), controlPoint1: CGPoint(x: 18.67, y: 12.72), controlPoint2: CGPoint(x: 18.62, y: 12.48))
        bezierPath.addCurve(to: CGPoint(x: 18.09, y: 11.84), controlPoint1: CGPoint(x: 18.4, y: 12.07), controlPoint2: CGPoint(x: 18.27, y: 11.94))
        bezierPath.addCurve(to: CGPoint(x: 16.84, y: 11.67), controlPoint1: CGPoint(x: 17.85, y: 11.71), controlPoint2: CGPoint(x: 17.61, y: 11.67))
        bezierPath.addLine(to: CGPoint(x: 15.17, y: 11.67))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 5.01, y: 5.01))
        bezierPath.addLine(to: CGPoint(x: 9.45, y: 0.56))
        bezierPath.addCurve(to: CGPoint(x: 9.68, y: 0.34), controlPoint1: CGPoint(x: 9.55, y: 0.47), controlPoint2: CGPoint(x: 9.62, y: 0.39))
        bezierPath.addCurve(to: CGPoint(x: 10.83, y: 0.05), controlPoint1: CGPoint(x: 10.01, y: 0.01), controlPoint2: CGPoint(x: 10.45, y: -0.06))
        bezierPath.addCurve(to: CGPoint(x: 11.08, y: 0.15), controlPoint1: CGPoint(x: 10.91, y: 0.07), controlPoint2: CGPoint(x: 11, y: 0.11))
        bezierPath.addCurve(to: CGPoint(x: 11.38, y: 0.4), controlPoint1: CGPoint(x: 11.19, y: 0.22), controlPoint2: CGPoint(x: 11.3, y: 0.3))
        bezierPath.addLine(to: CGPoint(x: 15.99, y: 5.01))
        bezierPath.addCurve(to: CGPoint(x: 15.99, y: 6.66), controlPoint1: CGPoint(x: 16.45, y: 5.47), controlPoint2: CGPoint(x: 16.45, y: 6.21))
        bezierPath.addCurve(to: CGPoint(x: 14.34, y: 6.66), controlPoint1: CGPoint(x: 15.54, y: 7.12), controlPoint2: CGPoint(x: 14.8, y: 7.12))
        bezierPath.addLine(to: CGPoint(x: 11.67, y: 3.99))
        bezierPath.addLine(to: CGPoint(x: 11.67, y: 18.67))
        bezierPath.addCurve(to: CGPoint(x: 10.5, y: 19.84), controlPoint1: CGPoint(x: 11.67, y: 19.31), controlPoint2: CGPoint(x: 11.14, y: 19.84))
        bezierPath.addCurve(to: CGPoint(x: 9.33, y: 18.67), controlPoint1: CGPoint(x: 9.86, y: 19.84), controlPoint2: CGPoint(x: 9.33, y: 19.31))
        bezierPath.addLine(to: CGPoint(x: 9.33, y: 3.99))
        bezierPath.addLine(to: CGPoint(x: 6.66, y: 6.66))
        bezierPath.addCurve(to: CGPoint(x: 5.01, y: 6.66), controlPoint1: CGPoint(x: 6.2, y: 7.12), controlPoint2: CGPoint(x: 5.46, y: 7.12))
        bezierPath.addCurve(to: CGPoint(x: 5.01, y: 5.01), controlPoint1: CGPoint(x: 4.55, y: 6.21), controlPoint2: CGPoint(x: 4.55, y: 5.47))
        bezierPath.close()
        fillColor.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class var imageOfShareIcon: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 21, height: 28), false, 0)
